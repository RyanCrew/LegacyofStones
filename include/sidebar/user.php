	...
	<div class="widget widget-wide mod mod-main">
		<div class="bd eason">
			...
			<div class="list-group">
				...
				?>
				<a href="<?php print $site_url; ?>user/itemshop" class="list-group-item list-group-item-action"><i class="fa fa-shopping-bag"></i> <?php print isset($lang['itemshop']) ? $lang['itemshop'] : 'Tienda'; ?></a>
				...
				<?php if($web_admin) { ?>
				<a href="#" class="list-group-item list-group-item-action disabled"><?php print isset($lang['admin-level']) ? $lang['admin-level'] : 'Nivel de permisos'; ?> <?php print $web_admin; ?></a>
				<?php } ?>
			</div>
			<?php } ?>
		</div>
