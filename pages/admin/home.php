...
<div class="list-group">
	...
	<a href="<?php print $site_url; ?>admin/itemshop" class="list-group-item list-group-item-action">
		<h5 class="list-group-item-heading"><i class="fa fa-shopping-bag fa-1" aria-hidden="true"></i> <?php print isset($lang['itemshop']) ? $lang['itemshop'] : 'Item Shop'; ?></h5>
		<p class="list-group-item-text"><?php print isset($lang['manage-items']) ? $lang['manage-items'] : 'Gestiona los items de la tienda'; ?></p>
	</a>
